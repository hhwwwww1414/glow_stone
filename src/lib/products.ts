...
const productSeed: Product[] = [
  {
    ...
    story:
      "Камень пришел из старой уральской коллекции поставщика и три года ждал оправы. Мастер сохранил его естественную асимметрию, чтобы украшение выглядело как артефакт, а не как серийная форма.",
    meaning:
  ...
  },
  {
    ...
    collectionSlug: "stones-of-power",
    category: "bracelets",
    stones: ["malachite"],
